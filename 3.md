...
graph TB
    ...
    subgraph "Layer 1:  - User Interface Layer"
        subgraph ""
            UI1[Cursor IDE<br/><br/>MCP Plugin]
            UI2[<br/>AI]
        end
        subgraph ""
            UI3[CLI<br/>]
    ...
    subgraph "Layer 2:  - Business Application Layer"
        subgraph ""
            APP1[Mobile-MCP Server<br/>MCP]
            APP2[AI<br/>]
            APP3[<br/>]
        end
        subgraph ""
            APP4[Midscene<br/>]
            APP5[UI<br/>Mobile-MCP UI]
            APP6[<br/>+]
            APP7[<br/>AI]
        end
    end
    ...
    %% ===== 3AI =====
    subgraph "Layer 3: AI - AI Service Layer"
        AI1[Gemini-2.5-Pro<br/>]
        AI2[GPT-4.0<br/>]
        AI3[<br/>API]
    end
    ...
    subgraph "Layer 4:  - Device Operation Layer"
        DEV1[Android<br/>ADB + UIAutomator]
        DEV2[iOS<br/>WebDriverAgent + XCTest]
        DEV3[<br/>]
        DEV4[UI<br/>UI]
    end
    ...
    subgraph "Layer 5:  - Device Driver Layer"
        DRV1[ADB<br/>Android]
        DRV2[WebDriverAgent<br/>iOS]
    end
    
    %% ===== 6 =====
    subgraph "Layer 6:  - Device Hardware Layer"
        HW1[Android/<br/>Android]
        HW2[iOS/<br/>iOS]
    end
...
|  |  |  |  |  |
|------|------|----------|----------|----------|
| **Layer 1** |  |  | Cursor IDECLI |  |
| **Layer 2** |  |  | Mobile-MCP ServerMidscene | / |
| **Layer 3** | AI | AI | Gemini-2.5-ProGPT-4.0 |  |
| **Layer 4** |  |  | Android/iOSUI |  |
| **Layer 5** |  |  | ADBWebDriverAgent |  |
| **Layer 6** |  | / | Android/iOS |  |
| **Layer 7** |  |  |  |  |
