...
graph TB
    ...
    subgraph "⚡ 双模式执行引擎"
        direction LR
        DEV_MODE[开发模式<br/>Mobile-MCP Server]
        PROD_MODE[回归模式<br/>扩展Midscene框架]
    end
    ...
    subgraph "📱 设备连接层"
        direction LR
        ADB_IOS[ADB + WebDriverAgent]
        DEVICES[Android/iOS 设备]
    end
    ...
    DEV_MODE --> DEVICE_MGR
    PROD_MODE --> DEVICE_MGR
    
    DEVICE_MGR --> UI_ENGINE
    DEVICE_MGR --> ADB_IOS
    ...
    style AI_HUB fill:#fff3e0,stroke:#ff9800,stroke-width:3px
    style GEMINI fill:#fff3e0,stroke:#ff9800,stroke-width:2px
    style GPT fill:#fff3e0,stroke:#ff9800,stroke-width:2px
    
    style DEV_MODE fill:#e8f5e8,stroke:#4caf50,stroke-width:3px
    style PROD_MODE fill:#f3e5f5,stroke:#9c27b0,stroke-width:3px
    
    style DEVICE_MGR fill:#e1f5fe,stroke:#03a9f4,stroke-width:3px
    style UI_ENGINE fill:#e1f5fe,stroke:#03a9f4,stroke-width:2px
    
    style ADB_IOS fill:#ede7f6,stroke:#673ab7,stroke-width:2px
    style DEVICES fill:#f5f5f5,stroke:#616161,stroke-width:2px
